...
export const getCartState = state => state.phones.cart;

export const getCartTotal = state => state.phones.total;

export const getAllPhoneBrands = state => state.phones.phones
...
export const getFilteredPhones = state => {
    const { phones: { phones }, filters } = state;
